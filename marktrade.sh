...
pip install --no-deps --index-url http://192.168.0.102:3141/root/dev tickmine --trusted-host devpi.cdsslh.com;
pip install --no-deps --index-url http://192.168.0.102:3141/root/dev ticknature --trusted-host devpi.cdsslh.com;
pip install --no-deps --index-url http://192.168.0.102:3141/root/dev ctpview --trusted-host devpi.cdsslh.com;
fi
fi
